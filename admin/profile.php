...
if(isset($_POST['save'])){
      ...
      if(!empty($_FILES["file"]["type"])){
        ...
        $password = md5($password);
                ...
                $sql = "UPDATE `restaurants` SET `image`='$uploadedFile',`rname`='$rname',`email`='$email',`password`='$password',`region`='$regions',`services`='$services',`address`='$address' WHERE res_id = '{$_SESSION['resid']}'";
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card card-warning card-outline">
              <div class="card-body">
                <h5 class="card-title"><i class="fa fa-edit"></i>&nbsp;EDIT RESTAURANT PROFILE</h5>
        <hr>
                        ...
                        <div class="">
                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                <div class="fileupload-new thumbnail form-control" style="width: 200px; height: 150px;">
                                 <?php echo  '<img src="../upload/'.$image.'" alt=""  />'?></div>
        ...
        <div class="form-group col-md-6 mb-3">
              ...
              <div class="form-group col-md-6 mb-3">
               ...
               <select class="form-control selectpicker" data-style="btn-dark" name="regions" id="regions" required>
         <option value="" disabled selected>****SELECT****</option>
               <option name="dansoman">Dansoman</option>
               <option name="roman_ridge">Roman Ridge</option>
               <option name="kaneshie">Kaneshie</option>
         <option name="zongo">Zongo</option>
         <option name="dzorwulu">Dzorwulu</option>
         <option name="cantonments">Cantonments</option>
         <option name="burma_camp">Burma Camp</option>
         <option name="new_town">New Town</option>
         <option name="kwashieman">Kwashieman</option>
         <option name="nii_boi_town">Nii Boi Town</option>
         <option name="nima">Nima</option>
         <option name="alajo">Alajo</option>
               </select>
              </div>
        <center><button type="submit" name="save" class="btn btn-danger btn-block">Save</button></center>
        </div>
            </form>
              </div>
            </div>
