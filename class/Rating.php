...
class Rating{
	...
	public function userLogin($username, $password){
		...
		$sqlQuery = "
			...
			WHERE user_name='".$username."' AND user_password='".$password1."'";
	...
	public function getItemRating($itemId){
		$sqlQuery = "
			SELECT r.ratingId, r.itemId, r.userId, u.user_name, r.ratingNumber, r.title, r.comments, r.created, r.modified
			FROM ".$this->itemRatingTable." as r
			LEFT JOIN ".$this->itemUsersTable." as u ON (r.userId = u.users_id)
